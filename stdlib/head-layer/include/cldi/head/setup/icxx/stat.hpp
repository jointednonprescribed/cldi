...
namespace cldi
{
	...
	constexpr STAT ETOO_FEW_ARGS = ::CLDI_ETOO_FEW_ARGS;
	constexpr STAT EOVERFLOW = ::CLDI_EOVERFLOW;
	constexpr STAT EOVERFLOW_ARG = ::CLDI_EOVERFLOW_ARG;
	constexpr STAT EOVERFLOW_ATTR = ::CLDI_EOVERFLOW_ATTR;
