...
#ifndef _cldi_head__setup_platform_bsd_OPENBSD_H
#define _cldi_head__setup_platform_bsd_OPENBSD_H 1
...
/* OpenBSD Platform Settings */
#define __CLDI_PLATFORM          CLDI_PLATFORM_OPENBSD
...
#endif /* _cldi_head__setup_platform_bsd_OPENBSD_H */
