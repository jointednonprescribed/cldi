...
#ifndef _cldi_head__setup_platform_bsd_NETBSD_H
#define _cldi_head__setup_platform_bsd_NETBSD_H 1
...
/* NetBSD Platform Settings */
#define __CLDI_PLATFORM          CLDI_PLATFORM_NETBSD
...
#endif /* _cldi_head__setup_platform_bsd_NETBSD_H */
