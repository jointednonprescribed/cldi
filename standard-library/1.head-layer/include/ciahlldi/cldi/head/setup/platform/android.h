...
#ifndef _cldi_head__setup_platform_ANDROID_H
#define _cldi_head__setup_platform_ANDROID_H 1
...
#define __CLDI_PLATFORM          CLDI_PLATFORM_ANDROID
...
#endif /* _cldi_head__setup_platform_ANDROID_H */
